...
15. 부 칙(시행일)  <br/>
<br />
현 개인정보처리방침은 2022년 11월 17일에 제정되었으며, 정부 및 회사의 정책 또는 보안기술의 변경에 따라 내용의 추가, 삭제 및 수정이 있을 경우에는 개정 최소 7일 전부터 ‘공지사항’란을 통해 고지하며, 본 정책은 시행 일자에 시행됩니다.  <br/>
1) 공고일자 : 2022년 11월 24일  <br/>
2) 시행일자 : 2022년 11월 24일  <br/>
</div>
</template>
